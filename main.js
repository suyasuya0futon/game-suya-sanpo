    ...
    document.querySelector("#helpContent").innerHTML = [
      ...
      "ブースト中は速く移動できるようになり、次のリングへのガイドが出て見つけやすくなります。",
      "機体の輪っかは燃料タンクです。空になるとブーストはできません。",
      "障害物に当たるとゲームオーバーです。",
...
const forestPalette = [0x173326, 0x1f4434, 0x2a563f, 0x12281d, 0x365e3c];
    ...
    function renderRankingRow(row, editingId) {
      ...
      const nameCell = isSelf
        ? `<td class="ranking-name-edit"><input id="rankingNameInput" maxlength="16" pattern="[A-Za-z0-9]+" autocomplete="off" value="nanashi"></td>`
