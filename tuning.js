...
// 危険高度と大気圏爆発
export const ATMOSPHERE_SPARK_START_Y = 370; // この高度から機体に火花が出始める。
export const ATMOSPHERE_EXPLODE_Y = 416; // この高度に達すると大気圏で爆発してゲームオーバーになる。
export const ATMOSPHERE_SPARK_RATE_MIN = 8; // 火花が出始めた直後の1秒あたり発生数。
export const ATMOSPHERE_SPARK_RATE_MAX = 72; // 爆発高度付近の1秒あたり発生数。
export const ATMOSPHERE_SPARK_SIZE = 0.08; // 危険高度で出る火花1粒の大きさ。
export const ATMOSPHERE_SPARK_SPREAD_X = 3.4; // 火花が機体の左右へ散る発生幅。
export const ATMOSPHERE_SPARK_SPREAD_Y = 1.2; // 火花が機体の上下へ散る発生幅。
export const ATMOSPHERE_SPARK_SPREAD_Z = 1.5; // 火花が機体の前後へ散る発生幅。
export const ATMOSPHERE_SPARK_SPEED_X = 5.5; // 火花が左右へ飛ぶ速度。
export const ATMOSPHERE_SPARK_SPEED_Y = 3.2; // 火花が上下へ飛ぶ速度。
export const ATMOSPHERE_SPARK_SPEED_Z = 6.8; // 火花が後方へ流れる速度。
export const ATMOSPHERE_SPARK_LIFE_BASE = 0.22; // 火花の基本寿命。
export const ATMOSPHERE_SPARK_LIFE_RANDOM = 0.26; // 火花の寿命に足すランダム幅。
export const ATMOSPHERE_SPARK_COLORS = [0xfff0a8, 0xff9b42, 0x8cefff]; // 危険高度の火花に使う色。
