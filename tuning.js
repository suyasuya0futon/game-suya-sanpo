export const PICKUP_RING_RADIUS = 6.0; // 通常リングの中心半径。
export const PICKUP_RING_TUBE_RADIUS = 0.06; // 通常リングの線の太さ。
...
export const GROUND_WRAP_DISTANCE = 480; // 地面/島がループする距離。大きいほど遠くから島が現れ、現れる頻度は下がる。
...
export const SPARKLE_RING_RADIUS = 6.2; // リング周囲の光の粒が並ぶ基本半径。
...
export const SPARKLE_RING_Z_RANDOM = 0.12; // リング周囲の光の粒の奥行きばらつき。
export const SPARKLE_RING_ANGULAR_SPEED = 0.4; // リング周囲の光の粒が回る速度のばらつき。
export const SPARKLE_COUNT = 40; // 通常リング周囲の光の粒数。
export const RAINBOW_SPARKLE_COUNT = 96; // レインボーリング周囲の光の粒数。
export const RING_BURST_PARTICLE_SIZE = 0.09; // リング取得時に出る火花1粒の大きさ。
