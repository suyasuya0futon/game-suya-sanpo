...
export const ATMOSPHERE_SPARK_RATE_MAX = 512; // 爆発高度付近の1秒あたり発生数。
...
export const ATMOSPHERE_SPARK_OFFSET_Y = 0.2; // 火花の発生位置を機体中心から上へずらす量。
export const ATMOSPHERE_SPARK_OFFSET_Z = -0.1; // 火花の発生位置を機体中心からテイル側へずらす量。
